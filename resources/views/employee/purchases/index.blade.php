                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <a class="btn btn-info text-white" href="excel">Export Purchase data (.xlsx)</a>
                                
                                <div class="ms-auto">
                                    <a class="btn btn-primary" href="purchasecreate">Add Purchase</a>
                                </div>
                            </div>
                                ...
                                <table id="purchases" class="table table-hover data">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start pointer">23-04-2024</td>
                                                <td class="text-start pointer">rp. 23.000</td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="text-end">
                                                        <p class="mb-1">Member Since : <strong>23-05-2025</strong></p>
                                                    </div>
                                                </div>
                                                <!-- Table Produk -->
                                                ...
                                                <div class="text-center mt-3">
                                                    <small>Created At : 23-05-23 </small><br>
                                                    <small>By : jeno</small>
                                                </div>
                                            </div>
